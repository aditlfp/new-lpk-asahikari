...
export default function Requirement({ onBackClick }) {
  const faqItems = [
    {
        ...
        <>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              ...
              (Laki/Perempuan Baju putih berdasi, background merah, LakiLaki
              rambut rapi/perempuan tanpa Hijab)
            </li>
          </ul>
        </>
      ),
  ...
  return (
    <section id="faq" className="px-4 mb-40 md:mx-20 md:mb-32 mt-20">
              ...
              <div className="flex justify-between items-center md:text-xl">
                ...
                <span>
                  {activeIndex === i ? (
                    ...
                    <FaChevronDown className="text-blue-700/70" />
                  )}
                </span>
              </div>
            </button>
